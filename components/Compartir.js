// components/Compartir.jsx
"use client";

export default function Compartir({ titulo, url }) {
  const compartir = {
  ...
  return (
    <div className="compartir-botones">
      ...
      <button
        onClick={() => abrir(compartir.facebook)}
      ...
      <button
        onClick={() => abrir(compartir.twitter)}
      ...
      <button
        onClick={() => abrir(compartir.whatsapp)}
      ...
      <button
        onClick={() => abrir(compartir.linkedin)}
      ...
      <button
        onClick={() => abrir(compartir.telegram)}
        className="btn-compartir telegram"
        title="Telegram"
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
